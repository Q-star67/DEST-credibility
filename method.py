...
m1=np.array([0.50,0.20,0.15,0.15])
m2=np.array([0.00,0.70,0.15,0.15])
m3=np.array([0.55,0.15,0.00,0.30])
m4=np.array([0.45,0.25,0.30,0.00])
m5=np.array([0.60,0.10,0.00,0.30])
evidence_matrix= np.array([m1, m2, m3,m4,m5])


"1.Jousselme distance"
m1 = {'A': 0.50, 'B': 0.20, 'C': 0.15, 'D': 0.15}
m2 = {'A': 0.00, 'B': 0.70, 'C': 0.15, 'D': 0.15}
m3 = {'A': 0.55, 'B': 0.15, 'C': 0.00, 'D': 0.30}
m4 = {'A': 0.45, 'B': 0.25, 'C': 0.30, 'D': 0.00}
m5 = {'A': 0.60, 'B': 0.10, 'C': 0.00, 'D': 0.30}
